...
import ui_voteInv_Choose from "../ui/voteChoose.png";
import ui_sound from "../ui/sound.png";
...
let soundfx = [];
import soundfx0 from "../music/voice/0.mp3";soundfx.push(soundfx0);
import soundfx1 from "../music/voice/1.mp3";soundfx.push(soundfx1);
import soundfx2 from "../music/voice/2.mp3";soundfx.push(soundfx2);
import soundfx3 from "../music/voice/3.mp3";soundfx.push(soundfx3);
import soundfx4 from "../music/voice/4.mp3";soundfx.push(soundfx4);
import soundfx5 from "../music/voice/5.mp3";soundfx.push(soundfx5);
import soundfx6 from "../music/voice/6.mp3";soundfx.push(soundfx6);
import soundfx7 from "../music/voice/7.mp3";soundfx.push(soundfx7);
import soundfx8 from "../music/voice/8.mp3";soundfx.push(soundfx8);
import soundfx9 from "../music/voice/9.mp3";soundfx.push(soundfx9);
import soundfx10 from "../music/voice/10.mp3";soundfx.push(soundfx10);
import soundfx11 from "../music/voice/11.mp3";soundfx.push(soundfx11);
...
export class GameControl {
	...
	start() {
		...
		selectWarning.innerHTML = "点击右下角查看线索";
		this.isHintTime = true;
